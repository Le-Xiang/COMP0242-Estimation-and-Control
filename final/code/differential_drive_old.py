...
from regulator_model_old import RegulatorModel
...
def main():
    ...
    state_x_for_linearization = np.array([0, 0, 0])  # initial x, y, theta
    cur_u_for_linearization = np.array([0, 0])  # initial velocity control
